...
> 核心课程。本 README 为完整版（含全章节目录）；逐讲笔记、论文清单与项目实现由后续专人完成，`notes/`、`papers/`、`projects/` 暂为空目录。
...
- 本目录仅含此 README；`notes/outline.md`、`papers.md`、`projects/` 正文由后续专人按统一规范补齐。
- 笔记语言：中文；代码实验：本轮只写不编译。
