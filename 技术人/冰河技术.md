...
BingheTeam / im-team
https://gitcode.net/BingheTeam/im-team

BingheTeam / flow
https://gitcode.net/BingheTeam/flow

https://gitcode.net/BingheTeam

D:\develops\git\gitcode\pressure-data>

seckillteam
知识星球-冰河技术
目的：为知识星球的用户提供项目代码提交空间，方便针对项目进行技术交流。
使用：作业项目提交、分享学习代码、提issues求助、也可以创建项目仓库提交代码。
要求：创建代码仓库时，需要遵循一定的准则，按照如下格式进行创建：项目名称-用户星球编号-作者名称，例如：seckill-1-binghe。
按照《中华人民共和国著作权法实施条例》未经原作者允许和书面授权，禁止以任何理由和目的，分享星球项目到其他任何github、gitee等平台，违反可追究进一步的法律责任。
秒杀，课后作业
https://gitcode.net/seckillteam
...
秒杀系统基本完结了，目前正在筹划下一个实战项目专栏，大家可以从下面的项目中进行投票，也可以添加自己想学的项目，票数最高的项目会成为下一个专栏重点打磨的项目。
