...
```
0x00007fb774960000	42K	/usr/lib64/librt-2.17.so
0x00007fb774b68000	86K	/usr/lib64/libgcc_s-4.8.5-20150702.so.1
0x00007fb774d7e000	1110K	/usr/lib64/libm-2.17.so
0x00007fb775080000	972K	/usr/lib64/libstdc++.so.6.0.19
0x00007fb775388000	17613K	/usr/lib/jvm/java-1.8.0-openjdk-1.8.0.282.b08-1.el7_9.x86_64/jre/lib/amd64/server/libjvm.so
0x00007fb776429000	2105K	/usr/lib64/libc-2.17.so
0x00007fb7767f7000	18K	/usr/lib64/libdl-2.17.so
0x00007fb7769fb000	69K	/usr/lib/jvm/java-1.8.0-openjdk-1.8.0.282.b08-1.el7_9.x86_64/lib/amd64/jli/libjli.so
0x00007fb776c0a000	88K	/usr/lib64/libz.so.1.2.7
0x00007fb776e20000	138K	/usr/lib64/libpthread-2.17.so
0x00007fb77703c000	159K	/usr/lib64/ld-2.17.so
```
...
centos 源 repl加上epel和nux基本够了



[centos7下添加NuxDextop仓库](https://blog.csdn.net/yaoqiwaimai/article/details/77163261)
...
[centos7 查看so依赖的库](https://blog.csdn.net/qq_19734597/article/details/102683895)





[gcc升级后更新libstdc++.so.6动态库](https://blog.csdn.net/na_beginning/article/details/53413997)



在升级gcc时，gcc编译会在gcc-temp目录中生成libstdc++.so.6，升级完毕，默认只会在/usr/local/lib64目录下包含最新的libstdc++.so.6动态库，而不会更新/usr/lib64目录下的libstdc++.so.6。而执行程序时，程序会优先从/usr/lib64目录下去寻找libstdc++.so.6，由于老版本的gcc在/usr/lib64中有一个旧版本的动态库libstdc++.so.6，导致程序以为自己找到了正确的动态库，实际上找到的却不是最新的。
