...
```
./soar --help > a.txt
Usage of E:\soar0.11.0\soar.exe:
  ...
  -log-output string
        LogOutput, 日志输出位置 (default "log/soar.log")
  ...
  -test-dsn string
        TestDSN, 测试环境数据库配置, username:password@tcp(ip:port)/schema (default "root:5Edidada@tcp(127.0.0.1:3306)/soar_test?charset=utf8")
  -trace
