package com.xxx.xxx.common.interceptor;

/**
 * 打印完整执行sql的拦截器
 * Created by zqhuang on 2017/10/24.
 */
...
public class MybatisInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        try{
            ...
            LOGGER.debug("【SQL】 "+ sql+ "\t\tparameter = "+parameter);
        }catch(Exception e){
    ...
    public static String showSql(Configuration configuration, BoundSql boundSql) {
        ...
        if (isNotEmpty(parameterMappings) && parameterObject != null) {
