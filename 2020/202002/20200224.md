...
因为OSGI是JCP提出的规范，Sun是不可能把模块化这么重要的一个特性的主导权拱手让人的
...
Piper架设在谷歌自己的分布式数据库系统（以前叫 Bigtable，现在改名 Spanner）之上，分布在全世界10个数据中心，保证世界各地的谷歌员工都有良好的访问速度。
...
配资
配资是一个经济学术语，指配资公司在你原有资金的基础上按照一定比例给你资金供你使用
金融术语 https://baike.baidu.com/item/%E9%85%8D%E8%B5%84
