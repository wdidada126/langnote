...
**Netty 4核心原理与手写RPC框架实战(博文视点出品)  鼓泡学院**
...
MapperProxy   //public class MapperProxy<T> implements InvocationHandler
...
性，因为Java 反射机制可以生成任意类型的动态代理类。java.lang.reflect.Proxy 类
