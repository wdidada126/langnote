...
根据公开信息，StarRocks在国内的商业化落地已覆盖金融、物流、地产、互联网等多个行业，且多为中大型企业。这里整理了部分可查证的中标及公开客户案例：

| 行业 | 中标/客户企业 | 项目/应用情况 | 中标供应商/服务商 | 中标金额/规模 |
| :--- | :--- | :--- | :--- | :--- |
| **金融** | 浙商证券 | 2026年StarRocks软件二期采购 | 北京镜舟科技有限公司 | 59.2万元 |
| **金融** | 中国民生银行信用卡中心 | 2026年度StarRocks软件标准及增值服务采购 | 深圳银兴智能数据有限公司 | 未披露 |
| **金融** | 华农保险 | 替换原有ClickHouse架构，用于报表和看板提速 | 镜舟科技（提供解决方案） | 未披露 |
| **地产** | 越秀地产 | 2025年数据中台应用分析库**Mirrorship**（StarRocks商业版）采购 | 北京镜舟科技有限公司 | 未披露 |
| **物流** | 京东物流 | 构建UData一站式自助分析平台，支撑约**10万**名一线业务人员 | StarRocks社区版（自身技术团队实施） | 集群规模30+个，计算节点超600个 |
| **保险** | 海保人寿 | 在DTCC大会上分享基于StarRocks的实践案例 | 未明确提及 | 未披露 |
| **汽车/互联网** | 汽车之家 | 智能推荐效果分析、流量宽表等场景，**日增约2亿条**数据 | 未明确提及 | 未披露 |
| **游戏** | 鹰角网络 | 基于阿里云EMR Serverless StarRocks构建实时数仓，支撑《明日方舟》等游戏精细化运营 | 阿里云 | 未披露 |

从这些信息中可以观察出几个特点：
*   **金融行业是典型应用领域**：券商、银行、保险等金融机构对数据平台的稳定性、高可用性要求极高，目前已有多个采购和落地案例，是目前商业化程度较高的行业。
*   **大型企业选择社区版+自建**：像京东物流、汽车之家这类拥有强大技术团队的企业，会选择使用开源版StarRocks进行大规模自建，以支撑海量数据和业务场景。
*   **商业化服务由生态伙伴提供**：除了StarRocks的商业化公司“镜舟科技”外，也有像“深圳银兴智能数据”这样的服务商为客户提供维保和增值服务。

> 中标信息的公开程度不一，部分项目可能在官方渠道公示后未广泛收录。以上信息基于公开结果公告及技术分享，可作为市场情况的参考。
