...
VoltDB is an in-memory online transaction processing (OLTP) database designed from the ground up to be the fastest most scalable OLTP system in the world.
