...
![JUC-锁升级过程](https://seazean.oss-cn-beijing.aliyuncs.com/img/Java/JUC-锁升级过程.png)
...
![JMM-可见性例子](https://seazean.oss-cn-beijing.aliyuncs.com/img/Java/JMM-可见性例子.png)
...
4. 如果对一个变量执行 lock 操作，将会清空工作内存中此变量的值，在执行引擎使用这个变量之前需要重新从主存加载
